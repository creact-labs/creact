...
const StateMachine: Component = () => {
  return (
    <>
      ...
      <p>
        <Trans
          k="docs.architecture.state_machine.resource_states_intro"
          components={[Code]}
        />
      </p>
      <DocTable
        ...
        rows={[
          [
            <Trans
              k="docs.architecture.state_machine.state_pending_name"
              components={[Code]}
            />,
          ...
          [
            <Trans
              k="docs.architecture.state_machine.state_applying_name"
              components={[Code]}
            />,
          ...
          [
            <Trans
              k="docs.architecture.state_machine.state_deployed_name"
              components={[Code]}
            />,
          ...
          [
            <Trans
              k="docs.architecture.state_machine.state_failed_name"
              components={[Code]}
            />,
      ...
      <p>
        <Trans
          k="docs.architecture.state_machine.deployment_status_body"
          components={[Code, Code, Code, Code, Code, Code]}
        />
      </p>
      ...
      <p>
        <Trans
          k="docs.architecture.state_machine.persistence_body"
      ...
      <p>
        <Trans
          k="docs.architecture.state_machine.crash_recovery_body"
      ...
      <p>
        <Trans
          k="docs.architecture.state_machine.audit_log_body"
      ...
      <p>
        <Trans
          k="docs.architecture.state_machine.source_body"
          components={[Code]}
        />
      </p>
    </>
