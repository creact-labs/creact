...
describe('Context Edge Cases', () => {
  ...
  describe('Complex Data Types', () => {
    it('should handle deeply nested objects', () => {
      ...
      function Parent() {
        return (
          <TestContext.Provider value={deepValue}>
            <Child />
          </TestContext.Provider>
        );
      }
    ...
    it('should handle arrays as context values', () => {
      ...
      function Parent() {
        return (
          <TestContext.Provider value={arrayValue}>
            <Child />
          </TestContext.Provider>
        );
      }
    ...
    it('should handle Map as context value', () => {
      ...
      function Parent() {
        return (
          <TestContext.Provider value={mapValue}>
            <Child />
          </TestContext.Provider>
        );
      }
    ...
    it('should handle Set as context value', () => {
      ...
      function Parent() {
        return (
          <TestContext.Provider value={setValue}>
            <Child />
          </TestContext.Provider>
        );
      }
  ...
  describe('Many Contexts', () => {
    it('should handle many independent contexts (stress test)', () => {
      const contexts = Array.from({ length: 10 }, (_, i) => createContext<number>(i));
