      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Rendered when no Match is truthy.</td>
          </tr>
          <tr>
            <td>
              <code>children</code>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Condition for this branch. Accepts a value or an accessor.</td>
          </tr>
          <tr>
            <td>
              <code>children</code>
            ...
            <td>Content or callback receiving the truthy value.</td>
          </tr>
        </tbody>
      </table>
