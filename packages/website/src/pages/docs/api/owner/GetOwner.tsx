...
const GetOwner: Component = () => {
  return (
    <>
      <h1>getOwner</h1>
      <p class="docs-description">Returns the current reactive owner (the computation or root that owns the current scope).</p>
      ...
      <p>
        The current <code>Owner</code>, or <code>null</code> if called outside a reactive scope.
      </p>

      <DocHeading level={2} id="usage">Usage</DocHeading>
      <DocCodeBlock code={`const owner = getOwner();
