...
const Unwrap: Component = () => {
  return (
    <>
      <h1>unwrap</h1>
      <p class="docs-description">Returns a deep clone of the underlying data from a store proxy, stripping all reactivity.</p>
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>store</code></td><td><code>T</code></td><td>A store proxy created by <code>createStore</code>.</td></tr>
        </tbody>
      </table>

      <DocHeading level={2} id="usage">Usage</DocHeading>
      <DocCodeBlock code={`const [store, setStore] = createStore({ count: 0 });
