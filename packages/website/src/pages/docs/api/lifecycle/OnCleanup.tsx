...
const OnCleanup: Component = () => {
  return (
    <>
      <h1>onCleanup</h1>
      <p class="docs-description">Registers a cleanup function on the current reactive owner. Runs when the owner is disposed or before an effect re-runs.</p>

      <DocCodeBlock code={`onCleanup(() => {
  clearInterval(interval);
});`} />

      <DocHeading level={2} id="reference">Reference</DocHeading>
      <ApiSignature name="onCleanup" signature="onCleanup<T extends () => any>(fn: T): T" />

      <DocHeading level={3} id="parameters">Parameters</DocHeading>
      <table>
        <thead><tr><th>Parameter</th><th>Type</th><th>Description</th></tr></thead>
        <tbody>
          <tr><td><code>fn</code></td><td><code>() =&gt; any</code></td><td>Cleanup function. Called when the owner disposes.</td></tr>
        </tbody>
      </table>
  ...
  // interval is cleared before the next run, or when disposed
      ...
      <Callout type="warning">
        <p>
          <code>onCleanup</code> called outside a <code>createRoot</code> or <code>render</code>
