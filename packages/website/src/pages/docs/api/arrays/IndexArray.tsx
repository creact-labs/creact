...
const IndexArray: Component = () => {
  return (
    <>
      <h1>indexArray</h1>
      <p class="docs-description">Indexed iteration. Each position is a reactive accessor. Best for primitive arrays.</p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td><code>mapFn</code></td><td><code>(v: Accessor&lt;T&gt;, i: number) =&gt; U</code></td><td>Map function. <code>v</code> is an accessor (reactive). <code>i</code> is a static index.</td></tr>
        </tbody>
      </table>

      <DocHeading level={2} id="usage">Usage</DocHeading>
      <DocCodeBlock code={`const [names, setNames] = createSignal(['Alice', 'Bob', 'Charlie']);
