...
const Untrack: Component = () => {
  return (
    <>
      <h1>untrack</h1>
      <p class="docs-description">Reads signals without creating reactive dependencies.</p>
      ...
      <table>
        ...
        <tbody>
          <tr><td><code>fn</code></td><td><code>() =&gt; T</code></td><td>Function to run without tracking. Signal reads inside won't register dependencies.</td></tr>
        </tbody>
      </table>
