...
import { generateInstanceNode } from "../../test/helpers/generate-nodes";
import type { InstanceNode } from "../src/instance";
import { serializeNode, serializeNodes } from "../src/memory";
